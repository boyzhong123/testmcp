  ...
  return (
    <main className="flex-1">
      <div className="container mx-auto px-6 py-16 md:py-24">
        ...
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-3">联系我们</h1>
        <p className="text-muted-foreground mb-12 max-w-lg">
          无论是企业合作还是技术咨询，我们期待与您对话。
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-3xl">
          <div className="space-y-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-1">邮箱 / Email</h3>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-1">地址 / Address</h3>
          ...
          <div className="border border-border/60 rounded-lg p-6">
            <h3 className="text-sm font-semibold mb-4">发送消息 / Send a Message</h3>
            <form className="space-y-4" onSubmit={e => { e.preventDefault(); alert('消息已发送 / Message sent'); }}>
              <input
                type="text"
              ...
              <textarea
                rows={4}
                placeholder="您的需求或问题 / Your message"
